...
class StepCountView extends StatelessWidget {
  final AnimationController? animationController;
  final Animation<double>? animation;

  const StepCountView({Key? key, this.animationController, this.animation})
      : super(key: key);
          ...
          child: Transform(
            ...
            child: Padding(
              ...
              child: Container(
                  //Future Builder
                  child: FutureBuilder(
                      future: RemoteService().getStepCount(),
                      builder: (BuildContext context,
                          AsyncSnapshot<StepCounts?> snapshot) {
                        if (!snapshot.hasData) {
                          return const Center(
                          ...
                          return Container(
                              ...
                              child: DataClass(
                                  datalist: snapshot.data as StepCounts));
                        }
                      })),
            ),
          ),
