...
class BmiView extends StatelessWidget {
  ...
  const BmiView({Key? key, this.animationController, this.animation})
      : super(key: key);
          ...
          child: Transform(
            ...
            child: Padding(
              ...
              child: Container(
                  //Future Builder
                  child: FutureBuilder(
                      future: RemoteService().getBmi(),
                      builder: (BuildContext context,
                          AsyncSnapshot<Bmis?> snapshot) {
                        if (!snapshot.hasData) {
                          return const Center(
                          ...
                          return Container(
                              ...
                              child:
                                  DataClass(datalist: snapshot.data as Bmis));
                        }
                      })),
            ),
          ),
